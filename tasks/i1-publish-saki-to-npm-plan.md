...
- [ ] `python3 -c "import yaml; d=yaml.safe_load(open('.github/workflows/release.yml')); assert set(d['jobs']) >= {'build','publish'}; assert d['jobs']['publish']['needs']=='build'; print('ok')"` → prints `ok`
